        ...
        <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
            <div class="p-4 sm:p-7">
                <div class="text-center">
                    <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Авторизация</h1>
                    ...
                    <form>
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input v-model="formRef.email" autocomplete="email" type="email" id="email" name="email" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="email-error">
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    ...
                                    <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium" href="/recovery">Забыли пароль?</a>
                                </div>
                                <div class="relative">
                                    <input v-model="formRef.password" type="password" id="password" name="password" autocomplete="current-password" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="password-error">
                            ...
                            <div class="flex items-center">
                                <div class="flex">
                                    <input v-model="formRef.remember" id="remember" name="remember" type="checkbox" class="shrink-0 mt-0.5 border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800">
                                </div>
                                <div class="ms-3">
                                    <label for="remember" class="text-sm dark:text-white">Запомнить меня</label>
                                </div>
                            </div>
                            <!-- End Checkbox -->

                            <button @click.prevent="login" :disabled="isLoading" type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Войти</button>
                        </div>
                    </form>
                    <!-- End Form -->
                </div>
	...
	setup() {
		...
		return {
			...
			login: () => {
				...
				userStore.login(formRef.value, (data, isError = false) => {
					if (!isError) {
